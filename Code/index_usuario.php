...
<a href="index_usuario.php" class="brand-logo center">Kaiba Corporation</a>
  ...
  <h3 class="light">Cards</h3>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td> <a href="#modal<?php echo $dados['id']; ?>"class="btn-floating yellow waves-effect waves-light btn modal-trigger"><i class="material-icons ">star</i></a> </td>  
